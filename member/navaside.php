        ...
        <div class="flex items-center ml-3">
          <div>
            <button type="button" class="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-black" aria-expanded="false" data-dropdown-toggle="dropdown-user">
              ...
              <img class="w-8 h-8 rounded-full" src="../assets/image/utsav.jpeg" alt="user photo">
            </button>
          </div>
          <div class="z-50 hidden my-4 text-base list-none  divide-y divide-gray-100 rounded shadow bg-black " id="dropdown-user">
            ...
            <ul class="py-1" role="none">
              ...
              <li>
                <a href="./dashboard.php" class="block px-4 py-2 text-sm text-gray-700 dark:text-white dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem"> <?php echo $row['MembershipType']; ?> Membership</a>
              </li>
              <li>
    ...
    <ul class="space-y-2 font-medium">
      <li class="pb-2">
        <a href="dashboard.php" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
          ...
          <span class="ml-3">Member Dashboard</span>
        </a>
      </li>
      <li class="pb-2">
        <a href="./availableclass.php" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
          ...
          <span class="flex-1 ml-3 whitespace-nowrap">Available Classes</span>
        </a>
      </li>

      <li class="pb-2">
        <a href="./joinedclass.php" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
          ...
          <span class="flex-1 ml-3 whitespace-nowrap"> Joined Classes</span>
        </a>
      ...
      <li class="pb-2">
        <a href="listdiet.php" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
          ...
          <span class="flex-1 ml-3 whitespace-nowrap">Diet And Workout</span>
        </a>
      </li>
