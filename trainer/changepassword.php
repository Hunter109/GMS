    ...
    if ($result->num_rows === 1) {
        ...
        if ($newPassword === $newPassword1) {
            ...
            if ($Password === $storedPassword) {
                ...
                $updateQuery = "UPDATE Trainers SET LoginPassword = '$latestPassword' WHERE TrainerID = '$trainerID'";

                if ($conn->query($updateQuery) === TRUE) {
                    $alert = '
                        <div class="bg-green-100 border border-green-400 text-green-700 px-4 mt-12 py-3 rounded-md flex justify-between items-center mb-4">
                         <span>
            ...
            // old password doestnot match 
                ...
                $alert = '
                 <div class="bg-red-100 border border-red-400 text-red-700 px-4 mt-12 py-3 rounded-md flex justify-between items-center mb-4">
                     <span>
