                ...
                <div class="overflow-x-auto">
                    <table class="w-[95%] sm:w-2/3 md:w-1/2 lg:w-[95%] table-auto mt-4 sm:m-6 md:m-6 lg:m-8 border border-black border-2">
                        <thead class="bg-black text-white">
                            <tr>
                                <th class="font-semibold p-2 md:p-4 border border-black border-2">Trainer</th>
                                <th class="font-semibold p-2 md:p-4 border border-black border-2">Details</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="even:bg-gray-200 odd:bg-gray-100">
                                <td class="font-semibold p-2 md:p-4 border border-black border-2 text-center">Trainer ID</td>
                                <td class="p-2 md:p-4 border border-black border-2 text-center text-sm md:text-base lg:text-lg"><b><?php echo $row['TrainerID']; ?></b></td>
                            </tr>
                            <tr class="even:bg-gray-200 odd:bg-gray-100">
                            ...
                            <tr class="even:bg-gray-200 odd:bg-gray-100">
                                <td class="font-semibold p-4 md:p-4 border border-black border-2 text-center">Shift </td>
                                <td class="p-4 md:p-4 border border-black border-2 text-center text-sm md:text-base lg:text-lg"><b><?php echo $row['Shift']; ?></b></td>
                            </tr>
                            <tr class="even:bg-gray-200 odd:bg-gray-100">
