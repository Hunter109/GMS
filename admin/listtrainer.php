...
<body class=" bg-gray-200">
                    ...
                    <table class="text-center text-sm font-light">
                        ...
                        <tbody>
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                class='text-white bg-green-500 hover:bg-green-700 py-2 px-[20px] rounded inline-flex items-center'> Edit <i class='fas fa-edit ml-2'></i>
                                </a>
                              </td>";
                                ...
                                echo "<tr><td class='whitespace-nowrap px-[20px] py-4'>No Trainers found. </td></tr>";
                            }
                            $conn->close();
    ...
    <div id="confirmationDiv" style="display: none; position: fixed; top: 0; left: 0; right: 0; bottom: 0; background: rgba(0, 0, 0, 0.5); z-index: 999;">
        <div style="background: white; width: 400px; padding: 20px; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); text-align: center; border-radius: 5px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.3);">
            <p style="font-size: 18px; margin-bottom: 20px;">Do you really want to update this trainer details?</p>
            <button onclick="updateTrainer()" style="background-color: #008000; color: white; padding: 10px 50px; border: none; border-radius: 5px; margin-right: 10px; cursor: pointer;">Yes</button>
    ...
    <script>
        ...
        function updateTrainer() {
            if (trainerupdate !== null) {
                window.location.href = 'updatetrainer.php?id=' + trainerupdate;
            }
        }
