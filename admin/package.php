...
<body>
    ...
    <div class="flex-1 ml-64 mt-20">
        <div class="flex">
            <div class="flex-1 bg-gradient-to-r from-gray-400 to-gray-500 shadow-md rounded-lg p-12 m-2 hover:from-gray-300 hover:to-gray-400 flex items-center transition duration-300 ease-in-out transform hover:-translate-y-1">
                <div class="flex-1 ml-4">
                    <h2 class="text-2xl font-bold mb-2 text-white">SILVER</h2>
                    <p class="text-4xl font-bold text-white"><?php echo $totalSilver; ?></p>
                </div>
                <div class="flex flex-col items-center">
                    <i class="material-icons text-yellow-100 sm:text-xl lg:text-4xl">star</i>
                    <a href="./silver.php" class="text-white hover:underline mt-2">View</a>
                </div>
            </div>
            <div class="flex-1 bg-gradient-to-r from-yellow-400 to-yellow-500 shadow-md rounded-lg p-12 m-2 hover:from-yellow-300 hover:to-yellow-400 flex items-center transition duration-300 ease-in-out transform hover:-translate-y-1">
                <div class="flex-1 ml-4">
                    <h2 class="text-2xl font-bold mb-2 text-white">GOLDEN</h2>
                    <p class="text-4xl font-bold text-white"><?php echo $totalGolden; ?></p>
                </div>
                <div class="flex flex-col items-center">
                    <i class="material-icons text-yellow-100 sm:text-xl lg:text-4xl">star</i>
                    <a href="./golden.php" class="text-white hover:underline mt-2">View</a>
                </div>
            </div>
            <div class="flex-1 bg-gradient-to-r from-purple-400 to-purple-500 shadow-md rounded-lg p-12 m-2 hover:from-purple-300 hover:to-purple-400 flex items-center transition duration-300 ease-in-out transform hover:-translate-y-1">
                <div class="flex-1 ml-4">
                    <h2 class="text-2xl font-bold mb-2 text-white">PLATINUM</h2>
                    <p class="text-4xl font-bold text-white"><?php echo $totalPlatinum; ?></p>
                </div>
                <div class="flex flex-col items-center">
                    <i class="material-icons text-yellow-100 sm:text-xl lg:text-4xl">star</i>
                    <a href="./platinum.php" class="text-white hover:underline mt-2">View</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-gray-200 p-4 ml-4 md:ml-64 mt-4 md:mt-8">
        <div class="flex flex-col md:flex-row justify-between items-center mb-4">
            <div class="w-full md:w-1/2 p-2 md:p-4 lg:p-6">
                <?php
                include './chartjs/packagebar.php';
    ...
    <div class="bg-gray-200 p-4 ml-4 md:ml-64 mt-4 md:mt-8">
        <div class="flex flex-col md:flex-row justify-between items-center mb-4">
            ...
            <div class="w-full md:w-1/2 p-2 md:p-4 lg:p-6">
                <div class="flex flex-col items-center"> <!-- Center the Pie Chart -->
                    <?php
                    include './chartjs/genderdonut.php';
                    ?>
