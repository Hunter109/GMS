...
if (isset($_POST['submit'])) {
    ...
    $password = md5(validate_form($_POST['password'])); // Encrypt the password using MD5
    ...
    if ($result->num_rows > 0) {
        ...
        $sql = "INSERT INTO Members (FullName, Dob, MobileNo, Address, Email, MembershipType, LoginPassword, Sex, Age, StartDate, ExpiryDate)
    ...
    <div class="registration-container mt-20 ml-64">
        ...
        <div class="flex justify-center items-start p-10 md:h-screen">
            <div class="w-full max-w md:bg-gray-200  md:p-8 rounded-md md:shadow-md">
                ...
                <div class="text-2xl font-semibold mb-4 ">Add Member Details</div>
                <div class="content">
                    <!-- REGISTRATION FORM  -->
                    <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST">
                        <div class="user-details flex flex-wrap justify-between mb-4">
                            ...
                            <div class="input-box mb-3 w-full md:w-[49%]">
                                ...
                                <input type="tel" name="phone-number" value="+977 " placeholder="Enter your phone number" required class="w-full px-3 py-2 placeholder-gray-500 border border-gray-300 rounded" />
                            </div>
                            <div class="input-box mb-3 w-full md:w-[49%]">
                            ...
                            <div class="input-box mb-3 w-full md:w-[49%]">
                                <span class="text-sm md:text-lg font-medium">Start Date</span>
                            ...
                            <div class="input-box mb-3 w-full md:w-[49%]">
                                <span class="text-sm md:text-lg font-medium">End Date</span>
